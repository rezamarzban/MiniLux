...
MiniLux, Build and install linux in 3 minutes. Boot to linux real root filesystem in less than two minutes. MiniLux is building ,installing and booting to it in five minutes.

MiniLux, Five minutes installing linux (Building ,installing and booting).
